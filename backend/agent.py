...
from tripxplo_api import get_packages, get_available_hotels, get_available_vehicles, get_available_activities  # assuming these exist
...
def query_node(state: AgentState) -> AgentState:
    ...
    # Extract search terms only for location or theme filtering
...
"""
        ...
        packages = get_packages(search=search_term)
